...
router.get('/', (request, response) => {
  return fetch(`https://calorie-coach-ms.herokuapp.com/graphql?query={recipes(numberOfIngredients:${request.query.q}){id,name,recipeUrl,foodType,preparationTime,calorieCount,numberOfIngredients}}`)
  .then(recipeData => {
